...
function arrayLikeKeys(value, inherited) {
  var isArr = isArray_default(value), isArg = !isArr && isArguments_default(value), isBuff = !isArr && !isArg && import_isBuffer.default(value), isType = !isArr && !isArg && !isBuff && isTypedArray_default(value), skipIndexes = isArr || isArg || isBuff || isType, result2 = skipIndexes ? baseTimes_default(value.length, String) : [], length = result2.length;
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    if (import_isBuffer2.default(value)) {
      return import_cloneBuffer.default(value, isDeep);
    }
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (isSameTag && import_isBuffer3.default(object)) {
    if (!import_isBuffer3.default(other)) {
      return false;
    }
    objIsArr = true;
    objIsObj = false;
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    var isArr = isArray_default(srcValue), isBuff = !isArr && import_isBuffer4.default(srcValue), isTyped = !isArr && !isBuff && isTypedArray_default(srcValue);
    newValue = srcValue;
    if (isArr || isBuff || isTyped) {
      if (isArray_default(objValue)) {
        ...
        isCommon = false;
        newValue = import_cloneBuffer2.default(srcValue, true);
      } else if (isTyped) {
        isCommon = false;
...
var import_isBuffer9 = __toModule(require_isBuffer());
...
function isEmpty(value) {
  ...
  if (isArrayLike_default(value) && (isArray_default(value) || typeof value == "string" || typeof value.splice == "function" || import_isBuffer5.default(value) || isTypedArray_default(value) || isArguments_default(value))) {
    return !value.length;
  }
...
function transform(object, iteratee2, accumulator) {
  var isArr = isArray_default(object), isArrLike = isArr || import_isBuffer6.default(object) || isTypedArray_default(object);
...
var import_isBuffer8 = __toModule(require_isBuffer());
...
var export_isBuffer = import_isBuffer9.default;
export {
  add_default as add,
